...
<script src="<?php print base_url () ?>js/retail_clients.js"></script>
	...
	<hr />
	Sell: <span id="retail_sell_0"><?php print $amount[0]['total_day_sell'] ?></span> <br />
	Buy: <span id="retail_buy_0"><?php print $amount[0]['total_day_buy'] ?></span> <br />
	...
	Sell: <span id="retail_sell_1"><?php print $amount[1]['total_day_sell'] ?></span> <br />
	Buy
	: <span id="retail_buy_1"><?php print $amount[1]['total_day_buy'] ?></span> <br />
